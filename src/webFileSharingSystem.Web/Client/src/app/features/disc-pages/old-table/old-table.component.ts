...
import { NgbTooltipModule, NgbDropdownModule, NgbProgressbarModule, NgbTooltip } from '@ng-bootstrap/ng-bootstrap';
...
import { FileStatus, ProgressStatus, AppFile } from '../../../core/models/app-file.model';
...
import { BaseTableContextMenuComponent } from '../my-files/base-table-context-menu/base-table-context-menu.component';
import { DragPreviewComponent } from '../my-files/drag-preview/drag-preview.component';
...
@Component({
  ...
  styleUrl: './old-table.component.scss'
})
