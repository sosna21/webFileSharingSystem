...
@Component({
  ...
  imports: [ReactiveFormsModule, RouterLink, TextInputComponent, BaseAuthPageComponent, CardMainContentComponent, MainActionBtnComponent, CardSecondaryContentComponent],
