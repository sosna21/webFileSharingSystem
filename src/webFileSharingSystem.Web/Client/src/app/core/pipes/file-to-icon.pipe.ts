...
export class FileToIconPipe implements PipeTransform {
  transform(file: BaseFile, withColor: boolean = true): string {
    ...
    if (mime.startsWith('image/'))
      return withColor
        ? 'bi-file-earmark-image text-warning-emphasis'
        : 'bi-file-earmark-image';
    if (mime.startsWith('video/'))
      return withColor
        ? 'bi-file-earmark-play text-dark-emphasis'
        : 'bi-file-earmark-play';
    if (mime.startsWith('audio/'))
      return withColor
        ? 'bi-file-earmark-music text-info-emphasis'
        : 'bi-file-earmark-music';
    if (mime.startsWith('text/'))
      return withColor
        ? 'bi-file-earmark-text text-body-emphasis'
        : 'bi-file-earmark-text';
    if (mime.startsWith('application/'))
      return withColor
        ? 'bi-file-earmark-code text-body-emphasis'
