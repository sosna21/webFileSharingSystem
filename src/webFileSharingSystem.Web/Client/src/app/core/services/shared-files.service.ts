...
import { SharedFileResponse } from '../models/shared-file-response.model';
...
export class SharedFilesService {
  private readonly sharedFilesUrl = `${environment.apiUrl}/Share`;
  ...
  readonly _fileResource = httpResource<SharedFileResponse>(() =>
    this._request()
  );

  private readonly _linkedFilesResponse = linkedSignal<
    SharedFileResponse | undefined,
    SharedFileResponse | undefined
  >({
