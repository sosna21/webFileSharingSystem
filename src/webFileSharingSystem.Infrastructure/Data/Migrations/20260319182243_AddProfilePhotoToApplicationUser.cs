...
{
    /// <inheritdoc />
    public partial class AddProfilePhotoToApplicationUser : Migration
    {
        /// <inheritdoc />
...
SELECT
    ...
    creator.PhotoAccessId AS CreatedByPhotoAccessId,
    sharer.PhotoAccessId  AS SharedUserPhotoAccessId,
    rp.FileStatus,
