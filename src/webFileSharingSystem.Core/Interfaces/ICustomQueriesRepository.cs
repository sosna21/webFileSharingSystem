...
namespace webFileSharingSystem.Core.Interfaces
{
    ...
    {
        Task<IEnumerable<FilePathPart>> FindPathToAllParentsForUserFile(int fileId,
            CancellationToken cancellationToken = default);

        Task<IEnumerable<FilePathPart>> FindPathToAllParentForSharedFile(int userId, int fileId,
            CancellationToken cancellationToken = default);
        ...
        Task<List<File>> GetListOfAllFilesFromLocations(IList<int> fileIds,
            CancellationToken cancellationToken = default);
